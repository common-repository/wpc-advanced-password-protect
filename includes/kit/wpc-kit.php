...
if ( ! class_exists( 'WPCleverKit' ) ) {
	class WPCleverKit {
		protected static $plugins = [
			...
			'wpc-advanced-password-protect'  => 'wpc-product-timer.php',
                        ...
                        <div class="plugin-card-top">
                            ...
                            <div class="action-links">
                                <ul class="plugin-action-buttons">
                                    ...
                                    <li>
                                        <a href="<?php echo esc_url( $details_link ); ?>" class="thickbox open-plugin-details-modal" aria-label="<?php echo esc_attr( sprintf( /* translators: plugin name */ esc_html__( 'More information about %s', 'wpc-kit' ), esc_html( $plugin['name'] ) ) ); ?>" title="<?php echo esc_attr( $plugin['name'] ); ?>">
